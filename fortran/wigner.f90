...
subroutine drc3jj_vec(two_l2, two_l3, two_m2, two_m3, nvec, &
                      thrcof, ndim, ier)
...
do i=1, nvec
  ...
  if (is_new) then
    ...
    l2(indexes_max) = 0.5 * two_l2(i)
    l3(indexes_max) = 0.5 * two_l3(i)
    m2(indexes_max) = 0.5 * two_m2(i)
    m3(indexes_max) = 0.5 * two_m3(i)
